...
namespace CierzoArena.Tests.Editor
{
    ...
    {
        [Test] public void NavigationAlwaysResolvesToOneValidPanel(){Assert.That(MainMenuController.ResolveSingleActivePanel(-1,5),Is.EqualTo(0));Assert.That(MainMenuController.ResolveSingleActivePanel(2,5),Is.EqualTo(2));Assert.That(MainMenuController.ResolveSingleActivePanel(9,5),Is.EqualTo(4));}
